...
const Shop = () => {
    ...
    useSEO({
        title: 'Shop All — Vintage & Designer Thrift Clothing',
        description: 'Browse the complete Second Thrift collection. Vintage clothing, designer streetwear, and bulk deals at wholesale prices. Free EU shipping.',
        path: '/shop',
    });
