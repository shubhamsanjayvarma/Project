...
const Contact = () => {
    ...
    useSEO({
        title: 'Contact Second Thrift — Get In Touch',
        description: 'Contact Second Thrift for questions about orders, shipping, bulk deals, or partnerships. Reach us via email, WhatsApp, or Instagram.',
        path: '/contact',
    });
