    ...
    faq: {
        ...
        content: [
            ...
            },
            {
                ...
                text: 'We accept secure payments via Stripe (credit card, debit card, Apple Pay, Google Pay). You will be redirected to a secure Stripe checkout page to complete your payment.'
            },
            {
    ...
    terms: {
        ...
        content: [
            ...
            },
            {
                ...
                text: 'Orders are confirmed once payment is received via Stripe. We reserve the right to cancel any order for any reason. In such cases, a full refund will be issued.'
            },
            {
                heading: '4. Pricing',
...
export const ShippingPage = () => {
    useSEO({ title: 'Shipping Information', description: 'Second Thrift shipping details — free EU shipping, delivery times, tracking, and bulk order logistics.', path: '/shipping' });
    return <InfoPage type="shipping" />;
};
export const ReturnsPage = () => {
    useSEO({ title: 'Returns & Refunds Policy', description: 'Second Thrift returns policy — 14-day returns, easy refund process via Stripe, and exchange guidelines.', path: '/returns' });
    return <InfoPage type="returns" />;
};
export const FAQPage = () => {
    useSEO({ title: 'Frequently Asked Questions', description: 'Common questions about Second Thrift — payment methods, shipping, returns, bulk orders, and more.', path: '/faq' });
    return <InfoPage type="faq" />;
};
export const TermsPage = () => {
    useSEO({ title: 'Terms & Conditions', description: 'Second Thrift terms and conditions — ordering, payment, returns, intellectual property, and liability.', path: '/terms' });
    return <InfoPage type="terms" />;
};
export const PrivacyPage = () => {
    useSEO({ title: 'Privacy Policy', description: 'Second Thrift privacy policy — data collection, storage, cookies, and your rights under GDPR.', path: '/privacy' });
